...
<div class="the-impact--wrapper">
    <div class="container">
        ...
        <!-- <div class="impact-structure--one">
            ...
            <div class="imapact-content">
                <h1 class="imapact-content--title">$3.1M</h1>
                <div class="imapact-content--para">Raised for we got next campaign</div>
            </div>

            <div class="imapact-content">
                <h1 class="imapact-content--title">12.4M+</h1>
                <div class="imapact-content--para">Instagram ad impressions to audience over 4 million</div>
            </div>
        ...
        <!-- <div class="impact-structure--two">
            ...
            <div class="imapact-content video-featuring">
                <h1 class="imapact-content--title">Videos featuring</h1>
        ...
        <div class="impact-structure--three">
            <div class="imapact-content">
                ...
                <div class="imapact-content--para">
                    <ul>
                        <li>Made 91K phone calls</li>
                        <li>Had 833 Relational Voter Leaders reach out (223 of them currently in prison) reach out to 15,958 voters who are returning citizens as their families</li>
                    </ul>
                </div>
            </div>
